...
func main() {
    ...
    fileSource := orgdatacore.NewFileDataSource("comprehensive_index.json")
...
The package expects data in the `comprehensive_index.json` format generated by the Python `orglib` indexing system from the cyborg project.
